...
| [`@dgkit/betting-math`](./packages/betting-math)                   | [![npm](https://img.shields.io/npm/v/@dgkit/betting-math)](https://www.npmjs.com/package/@dgkit/betting-math)                   | Pure, exact-rational sports-betting math — odds conversion, system bets, dead heat, Rule 4, each-way, Asian handicap, cash-out. |
